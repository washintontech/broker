...
@Component
public class InboundFixApplication extends MessageCracker implements Application {

    private static final Logger log = LogManager.getLogger(InboundFixApplication.class);

    //private final Map<String, NewOrderSingle> activeOrders = new ConcurrentHashMap<>();


    private SessionID sessionId;

    public void submitOrder(InboundTradeRequest inboundTradeRequest) {
        try {
            Session.sendToTarget(inboundTradeRequest, sessionId);
    ...
    @Override
    public void fromAdmin(final Message message, final SessionID sessionId) throws FieldNotFound, IncorrectDataFormat,
